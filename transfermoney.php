...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center pt-4  ff" style="color : #8B4513  ;">Transfer Money</h2>
        <br>
        <div class="row shadow text-center" style="background-color: #A9A9A9;">
            <div class="col">
                <div class="table-responsive-sm pt-3">
                    <table class="table table-hover table-sm  table-condensed table-bordered" style="border-color:#B0C4DE;">
    ...
    <footer class="text-center mt-5 py-2">
        <p style="font-family: poppins; font-size: 16px;">&copy 2021. Developed by <b>AMOGH D C</b> <br> Sparks Foundation</p>
    </footer>
