  ...
  <div class="container-fluid">
    ...
    <div class="row intro py-1 bg ">
      ...
      <div class="col-sm-12 col-md img text-center">
        <img src="bank1.jpg" class="img-fluid pt-2" style="width:400px;">
      </div>
    </div>
